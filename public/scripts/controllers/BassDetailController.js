angular.module("babelInstruments").controller("BassDetailController", ["$scope", "$routeParams", "$location", "$sce", "URL", "APIClient", "paths", "authService", "buyService","logService",
    function($scope, $routeParams, $location, $sce, URL, APIClient, paths, authService, buyService, logService) {
